...
#include "task_XKC_Y20_V.h"// ���� XKC_Y20_V ������ҵ��
#include "task_ntc.h"      // NTC温度采集任务
...
void StartTask_NTC(void const * argument);
...
void MX_FREERTOS_Init(void) {
  ...
  /* definition and creation of Task_NTC */
  osThreadDef(Task_NTC, StartTask_NTC, osPriorityNormal, 0, 256);
  Task_NTCHandle = osThreadCreate(osThread(Task_NTC), NULL);
...
void StartTask_LED(void const * argument)
{
  ...
  /* Infinite loop */
Task_LED_Process(argument); // ֱ�ӵ����ⲿ�ļ���װ�õĴ���
  for(;;) { osDelay(1); }     // ���ױ���
...
void StartTask_RS485(void const * argument)
{
  ...
  /* Infinite loop */
Task_RS485Log_Process(argument); // ���غ���ҵ��
  for(;;) { osDelay(1); }          // ���ױ���
...
void StartTask03(void const * argument)
{
  ...
  /* Infinite loop */
Task_Panel_Process(argument); // ��������д����Ļ����ϵͳ��
  for(;;) { osDelay(1); }
...
void StartTask_XKC(void const * argument)
{
  ...
  /* Infinite loop */
Task_XKC_Y20_V_Process(argument); // <--- ���޸����������ר��������
